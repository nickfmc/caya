...
// register ###REPLACE_ME### custom taxonomy
 add_action( 'init', 'gdt_areaofpractice_reg', 0 );

// create taxonomy, for the post type(s) you connect it to below
function gdt_areaofpractice_reg() {
  // Add new taxonomy, make it hierarchical (like categories)
  $singular = 'Area of Practice';
  $plural = 'Areas of Practice';
  $labels = array(
    'name'              => "$plural",
  ...
  register_taxonomy( 'areaofpractice_tax', array( 'team_type' ), $args );
}
