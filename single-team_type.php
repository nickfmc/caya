...
<?php if( has_term( 'Registered Clinical Counsellor', 'areaofpractice_tax' ) ): ?>
...
<?php if( has_term( 'Registered Dietitian', 'areaofpractice_tax' ) ): ?>
  <!-- Check if the post has the term 'Registered Clinical Counsellor' in the 'areaofpractice_tax' taxonomy -->
<div class="c-team-cta">
  <div class="o-wrapper-wide">
  <h2>Book an Appointment</h2>
...
<?php if( has_term( 'Registered Massage Therapist', 'areaofpractice_tax' ) ): ?>
  <!-- Check if the post has the term 'Registered Clinical Counsellor' in the 'areaofpractice_tax' taxonomy -->
<div class="c-team-cta">
  <div class="o-wrapper-wide">
  <h2>Book an Appointment</h2>
